...
exports.command = 'ci [directory]';
exports.describe = 'Tests a local project with the worker process';
...
exports.builder = (yargs) => {
    return yargs
        ...
        .option('repo', Object.assign({}, (SLUG != null) ? { default: REPO } : {}, { demandOption: true, describe: 'Full repository URL', type: 'string' }))
        .option('version', {
        coerce: semver.valid,
        default: '0.0.1',
...
function handler(argv) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield fs.copy(projectDir, path.resolve(worker.workspace, 'clean'), { overwrite: true });
        yield fs.copy(projectDir, path.resolve(worker.workspace, 'dirty'), { overwrite: true });
